...
<div class="wmd-panel">
    <form method="POST">
        ...
        <br>
        <select class="select2" name="category" style="width: 35%;">
        ...
        <br>
        <input type="text" class="text form-control <?php if (isset($postTag)) { if (empty($postTag)) { echo 'error';}} ?>" name="tag" value="<?php if (isset($postTag)) { echo $postTag; } ?>"/>
        <br>
        Url (optional)<br><input type="text" class="text form-control" name="url" value="<?php if (isset($postUrl)) { echo $postUrl;} ?>"/>
        <span class="help">If the url leave empty we will use the post title.</span>
        <br>
        <br>
        Meta Description (optional)<br>
        <textarea name="description" rows="3" cols="20" style="width:100%;"><?php if (isset($p->description)) { echo $p->description;} ?></textarea>
        <br>
        <br>
        ...
        <br>
        <textarea rows="3" cols="20" class="text media-textinput form-control <?php if (isset($postAudio)) { if (empty($postAudio)) { echo 'error';} } ?>" name="audio"><?php if (isset($postAudio)) { echo $postAudio;} ?></textarea>
        ...
        <br>
        <textarea rows="3" cols="20" class="text media-textinput form-control <?php if (isset($postVideo)) { if (empty($postVideo)) { echo 'error';} } ?>" name="video"><?php if (isset($postVideo)) { echo $postVideo;} ?></textarea>
        ...
        <br>
        <textarea rows="3" cols="20" class="text media-textinput form-control <?php if (isset($postImage)) { if (empty($postImage)) { echo 'error';} } ?>" name="image"><?php if (isset($postImage)) { echo $postImage;} ?></textarea>
        ...
        <br>
        <textarea rows="3" cols="20" class="text media-textinput form-control <?php if (isset($postQuote)) { if (empty($postQuote)) { echo 'error';} } ?>" name="quote"><?php if (isset($postQuote)) { echo $postQuote;} ?></textarea>
        ...
        <br>
        <textarea rows="3" cols="20" class="text media-textinput form-control <?php if (isset($postLink)) { if (empty($postLink)) { echo 'error';} } ?>" name="link"><?php if (isset($postLink)) { echo $postLink;} ?></textarea>
        ...
        <textarea id="wmd-input" class="wmd-input <?php echo $editorClass ?>" name="content" cols="20" rows="10"><?php if (isset($postContent)) { echo $postContent;} ?></textarea>
        <br/>
