...
function generate_meta($type = null, $object = null) 
{
    ...
    if (is_null($object)) {
        ...
        if ($type == 'is_post') {
            ...
            $tags .= '<meta name="article:section" content="'. $section .'" />' . "\n";
